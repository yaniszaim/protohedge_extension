...
- `spot_delta_band`: mean `-0.013530`, CVaR5 `-0.052928`, shortfall `0.733333`, selected band `0.000000`, bound occupancy `0.006667`
...
- Best mean: `proto_source=spot_delta_k=10_weighted=0_learnw=0` with mean `-0.024726` and CVaR5 `-0.095233`.
- Best downside tail: `proto_source=spot_delta_k=10_weighted=0_learnw=0` with CVaR5 `-0.095233` and mean `-0.024726`.
- Lowest shortfall probability: `proto_source=spot_delta_k=10_weighted=0_learnw=0` with shortfall `0.733333`.

Best ProtoHedge mean minus vanilla mean: `0.041304`.
Best ProtoHedge mean minus unhedged mean: `-0.007478`.
Best ProtoHedge mean minus spot-delta mean: `-0.011195`.
Best ProtoHedge mean minus tuned spot-delta-band mean: `-0.011195`.
Best ProtoHedge bound occupancy: `0.500000`.
Best ProtoHedge path touch rate: `1.000000`.
Vanilla bound occupancy: `0.875000`.
Best screen-passing ProtoHedge: `proto_source=spot_delta_k=10_weighted=0_learnw=0` with mean `-0.024726` and bound occupancy `0.500000`.
